...
params:
  ...
  values_row: '[{"data_names":"ex_EPIC","data_paths":"inst/extdata/EPIC/sample_sheet_EPIC.rds","arraytype":"EPIC","norm":"noob","project_name":"name"}]'
...
Platform: [EPIC,EPICv2,450K Human, mouse]
...
Double check the sample_sheet (Raw data is available, factors are defined, sample names are uniq).
