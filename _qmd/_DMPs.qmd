...
ii) analyse the following contrasts (list of comparisons): `r contrasts_name`
...
## `r paste0("Step ",idx,": Differentially methylated CpG probes (DMPs) ")`
...
- Minimum mean methylation difference between groups: mdiff > 0.1 
