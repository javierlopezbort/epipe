...
## `r paste0("Step ",idx,": Differentially methylated Regions (DMRs)")`
...
- Minimum length: three CpGs  

- Minimum mean group methylation differences: < 0.05 

- Statistically different at: FDR<0.01 (default). 
