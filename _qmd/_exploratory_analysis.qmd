...
Variables with significant correlation for PC1 and PC2: Leukocyte, Neutrophil, Age, Sex, purity,mutation

![Bi-plots](`r file.path(paths$bplots_folder, paste0('/10000/','colored.by.leuk.prop_shape.condition1_10000.png'))`){#fig-Biplot}

![Bi-plots](`r file.path(paths$bplots_folder, paste0('/10000/','colored.by.Neu_shape.condition1_10000.png'))`){#fig-Biplot}

![Bi-plots](`r file.path(paths$bplots_folder, paste0('/10000/','colored.by.age_shape.condition1_10000.png'))`){#fig-Biplot}

![Bi-plots](`r file.path(paths$bplots_folder, paste0('/10000/','colored.by.predictedSex_shape.condition1_10000.png'))`){#fig-Biplot}

![Bi-plots](`r file.path(paths$bplots_folder, paste0('/10000/','colored.by.purity_shape.condition1_10000.png'))`){#fig-Biplot}

![Bi-plots](`r file.path(paths$bplots_folder, paste0('/10000/','colored.by.mutation_shape.condition1_10000.png'))`){#fig-Biplot}
