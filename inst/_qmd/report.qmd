...
cat("\n")
a <- knitr::knit_child(system.file("_qmd/_quality_control_analyst.qmd", package = "epipe"), quiet = FALSE)
cat(a, sep = "\n")
...
# paths <- jsonlite::fromJSON(params$paths)
cat("\n")
d <- knitr::knit_child(system.file("_qmd/_DMPs.qmd", package = "epipe"), quiet = TRUE)
cat(d, sep = "\n")
#N<-NULL
```
